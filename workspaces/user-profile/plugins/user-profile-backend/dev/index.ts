...
//
//   curl http://localhost:7007/api/user-profile/todos -H 'Content-Type: application/json' -d '{"title": "My Todo"}'
//   curl http://localhost:7007/api/user-profile/todos -H 'Content-Type: application/json' -d '{"title": "My Todo", "entityRef": "component:default/sample"}'
//
// List TODOs:
//
//   curl http://localhost:7007/api/user-profile/todos
//
// Explicitly make an unauthenticated request, or with service auth:
//
//   curl http://localhost:7007/api/user-profile/todos -H 'Authorization: Bearer mock-none-token'
//   curl http://localhost:7007/api/user-profile/todos -H 'Authorization: Bearer mock-service-token'
