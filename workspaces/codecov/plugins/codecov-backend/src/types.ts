...
/**
 * Identifies a single repository on Codecov.
 *
 * @public
 */
export interface CodecovRepoSlug {
  /** Source control provider, e.g. `github`, `gitlab` or `bitbucket`. */
  service: string;
...
/**
 * Normalized code coverage information for a single repository.
 *
 * @public
 */
export interface CodecovCoverage extends CodecovRepoSlug {
