...
//
//   curl http://localhost:7007/api/prow/todos -H 'Content-Type: application/json' -d '{"title": "My Todo"}'
//   curl http://localhost:7007/api/prow/todos -H 'Content-Type: application/json' -d '{"title": "My Todo", "entityRef": "component:default/sample"}'
//
// List TODOs:
//
//   curl http://localhost:7007/api/prow/todos
//
// Explicitly make an unauthenticated request, or with service auth:
//
//   curl http://localhost:7007/api/prow/todos -H 'Authorization: Bearer mock-none-token'
//   curl http://localhost:7007/api/prow/todos -H 'Authorization: Bearer mock-service-token'
